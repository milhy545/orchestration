...
def test_run_has_agent_with_auth_success():
    ...
    with patch('claude_session_bridge.find_claude_credentials', return_value=mock_creds), \
...
def test_run_has_agent_with_auth_no_creds():
    ...
    with patch('claude_session_bridge.find_claude_credentials', return_value=None), \
         patch('os.environ', mock_env), \
         patch('haiku_agent.HASClaudeAgent') as mock_agent_class:
