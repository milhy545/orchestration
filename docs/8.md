...
🌐 Network endpoints:
- Production: http://192.168.0.58:7000/mcp
- Health check: http://192.168.0.58:7000/health  
- Service discovery: http://192.168.0.58:7000/services
...
```
Internet → ZEN Coordinator (7000) → MCP Services (7001-7011)
...
# Verification
curl http://localhost:7000/mcp  # Test coordinator
...
|------|---------|-----------|--------|---------|
| **7001** | **Filesystem MCP** | mcp-filesystem | ✅ Up 26h | File operations |
| **7002** | **Git MCP** | mcp-git | ✅ Up 26h | Version control |
| **7003** | **Terminal MCP** | mcp-terminal | ✅ Up 26h | Shell commands |
| **7004** | **Database MCP** | mcp-database | ✅ Up 26h | DB operations |
| **7005** | **Memory MCP** | mcp-memory | ✅ Up 26h | Memory management |
| **7011** | **Research MCP** | mcp-research | ✅ Up 26h | AI Research |
| **7012** | **Advanced Memory** | mcp-advanced-memory | ✅ Up 26h | **Vector Memory!** |
| **7013** | **Transcriber MCP** | mcp-transcriber | ⚠️ Up 26h (unhealthy) | Audio processing |
| **7021** | **PostgreSQL** | mcp-postgresql | ✅ Up 26h | Main database |
| **7022** | **Redis** | mcp-redis | ✅ Up 26h | Cache layer |
...
├─────────────────────────────────────────────────────────────┤
│  🧠 CLDMEMORY (7006)     🤖 Gemini AI Embeddings            │
...
```bash
# Primary target
192.168.0.58:7000  # ZEN Coordinator (Home Automation Server)

# Development target  
192.168.0.10:7000  # Workstation (Development/Testing)
```
...
✅ 6379  - Redis Cache  
✅ 7001-7008 - MCP Services
✅ 7000  - ZEN Coordinator
...
| **Advanced Memory** | ✅ Port 7012 | ✅ mcp-advanced-memory | ❌ Old port mapping |
...
- Advanced Memory MCP (port 7012) - Enhanced vector operations
...
# Port evolution:
OLD: Memory on 8005, Transcriber on 8013
NEW: Memory on 7005, Advanced Memory on 7012, Transcriber on 7013
```
...
- **Advanced Memory Architecture** - Enhanced vector operations (port 7012)
...
### 🚀 **UNIQUE DISCOVERIES:**
- **Advanced Memory MCP** - Nová služba na portu 7012 (nebyla v lokálních zálohách)
- **Extended Service Portfolio** - Config, Log, Network, Security, System MCPs
- **Production Port Evolution** - Memory 8005→7005, Advanced Memory 8012→7012, Transcriber 8013→7013
